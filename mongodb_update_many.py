...
db=client['sai']
coll=db['col1']
res=coll.update_many({"name":{"$regex":"^n"}},{"$set":{"name":"bncv"}})
for x in coll.find():
    print(x)
...
# {'_id': ObjectId('6629f1ff11ade2d23b46b7a2'), 'name': 'bncv', 'age': '34'}
# {'_id': ObjectId('6629f1ff11ade2d23b46b7a1'), 'name': 'bncv', 'age': '78'}
